const aboutTexts = {
  ...
  "about-desc": {
	...
	"about-subtitle": {
		...
		"2": {
			ru: "Наши решения успешно опробованы на:",
			en: "Our solutions have been successfully tested at:",
		}
	},
	"about-achievement": {
		"1": {
			ru: "Свидетельство о регистрации ПО “DotPulse”",
			en: "Certificate of Registration for Software “DotPulse”",
		},
		"2": {
			ru: "Комплект конструкторской документации и декларация соответствия на устройства “DotPulse”",
			en: "A set of engineering documentation and a declaration of conformity for “DotPulse” devices",
		},
		"3": {
			ru: "Резиденты и грантополучатели “Сколково” и “Фонда содействия инновациям”",
			en: "Resident and grantee of “Skolkovo” and “Foundation for Assistance to Small Innovative Enterprises (FASIE)”",
		}
	},
	"about-tagline": {
